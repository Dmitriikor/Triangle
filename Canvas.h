...
private:
	...
	bool is_last_change_update_points_;		//! @param is_last_change_update_points_  Обновила ли массив точек (points_to_draw_) последняя попытка добавления или удаления?
	bool is_last_change_update_min_;		//! @param is_last_change_update_min_ Обновила ли минимум (MIN_VIRTUAL_) последняя попытка добавления или удаления?
	bool is_last_change_update_max_;		//! @param is_last_change_update_max_ Обновила ли максимум (MAX_VIRTUAL_) последняя попытка добавления или удаления?
